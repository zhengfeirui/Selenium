...
public class mainprg {
	...
	
	{
		...
		FirefoxDriver ds = new FirefoxDriver();
		 ...
		 Thread.sleep(1000);
		 ds.findElement(By.linkText("Daily Share Prices")).click();
		 
		 
		 Thread.sleep(1000);
		 WebElement table = ds.findElement(By.id("gridSource"));
			 ...
			 if(r.getText().isEmpty())
  			 {
  				 ...
  				 ds.findElement(By.xpath(".//*[@id='gridSource']/tfoot/tr/td[3]")).click();
